...
- **📺 Regarde Twitch par-dessus ton jeu** — jusqu'à **quatre lives** dessinés par-dessus le jeu en Mode Jeu. Tes **chaînes suivies en direct** sont listées avec miniature et nombre de spectateurs : un appui et le live démarre. Disposition, taille, opacité et fréquence d'image se règlent depuis le QAM ; tu choisis **quel son** tu écoutes, avec son propre volume, toujours sur ta sortie audio par défaut. *(Les chaînes suivies demandent une reconnexion Twitch après la mise à jour, pour accorder la nouvelle permission.)*
