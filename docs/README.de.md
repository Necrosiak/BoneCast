...
- **📺 Twitch über deinem Spiel ansehen** — bis zu **vier Livestreams** im Spielmodus über dem Spiel. Deine **gefolgten Kanäle, die live sind**, erscheinen mit Vorschaubild und Zuschauerzahl: antippen und der Stream läuft. Anordnung, Größe, Deckkraft und Bildrate stellst du im QAM ein; du wählst, **wessen Ton** du hörst, mit eigener Lautstärke, immer auf deiner Standard-Audioausgabe. *(Für gefolgte Kanäle ist nach dem Update einmal eine neue Twitch-Anmeldung nötig, um die neue Berechtigung zu erteilen.)*
