...
- **📺 Assista à Twitch por cima do jogo** — até **quatro lives** desenhadas sobre o jogo no Modo Jogo. Seus **canais seguidos ao vivo** aparecem com miniatura e número de espectadores: toque e a live começa. Disposição, tamanho, opacidade e taxa de quadros são ajustados no QAM; você escolhe **qual som** ouvir, com volume próprio, sempre na saída de áudio padrão. *(Os canais seguidos exigem reconectar a Twitch uma vez após a atualização, para conceder a nova permissão.)*
