...
- **📺 Guarda Twitch sopra il gioco** — fino a **quattro live** disegnate sopra il gioco in Modalità Gioco. I tuoi **canali seguiti in diretta** sono elencati con miniatura e numero di spettatori: toccane uno e parte. Disposizione, dimensione, opacità e frame rate si regolano dal QAM; scegli **quale audio** ascoltare, con il suo volume, sempre sull'uscita audio predefinita. *(I canali seguiti richiedono di ricollegare Twitch una volta dopo l'aggiornamento, per concedere il nuovo permesso.)*
