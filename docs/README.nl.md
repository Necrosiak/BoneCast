...
- **📺 Kijk Twitch boven je game** — tot **vier livestreams** boven de game in Gamemodus. Je **gevolgde kanalen die live zijn** staan erbij met miniatuur en kijkersaantal: tik erop en hij speelt. Indeling, grootte, dekking en framerate stel je in via het QAM; je kiest **wiens geluid** je hoort, met eigen volume, altijd via je standaard audio-uitvoer. *(Voor gevolgde kanalen moet je na de update één keer opnieuw met Twitch verbinden om de nieuwe toestemming te geven.)*
